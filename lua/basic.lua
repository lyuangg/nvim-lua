...
vim.api.nvim_set_keymap("n", "<C-ScrollWheelDown>", "zl", { noremap = true }) -- 将Ctrl+滚轮向下映射为zl
vim.api.nvim_set_keymap("n", "<C-ScrollWheelUp>", "zh", { noremap = true }) -- 将Ctrl+滚轮向上映射为zh
...
vim.opt.backupdir = "~/.vim/.backup//" -- 设置备份文件的保存位置
vim.opt.directory = "~/.vim/.swp//" -- 设置交换文件的保存位置
vim.opt.undodir = "~/.vim/.undo//" -- 设置操作历史文件的保存位置
